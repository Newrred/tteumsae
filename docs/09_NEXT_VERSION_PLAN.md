...
11. [ ] 전국주차장 표준데이터를 `주변 공영주차장`으로 분리 제공
12. [ ] 체류시간·연관관광지·두루누비는 Gate 3 사용자 근거가 생긴 뒤 재평가

상세·혼잡·날씨 코드는 운영 배포됐고 migration 007~009도 적용됐다. 새 외부 키,
날씨 기능 활성화와 혼잡 Cron 예약은 실데이터 검증 뒤 별도 운영 변경으로 진행한다.
